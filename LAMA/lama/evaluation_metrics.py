...
def __print_top_k(value_max_probs, index_max_probs, vocab, mask_topk, index_list, max_printouts = 1000):
    result = []
...
def get_ranking(log_probs, masked_indices, vocab, label_index = None, index_list = None, topk = 1000, P_AT = 10, print_generation=True):
    ...
    ret = {}
    for e in result_masked_topk:  
        ret[e['token_word_form']] = e['log_prob']
   # print(ret)
   # if print_generation:
   #     print(return_msg)
